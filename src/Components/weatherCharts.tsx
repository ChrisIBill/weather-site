...
const AreaChartHandler = ({ weatherData }: { weatherData: AreaChartHandlerProps }) => {
...
function areaChartDatasetGenerator(weatherDataset: WeatherDataType) {
	if (weatherDataset.hourly != undefined) {
		const hoursData: HourlyWeatherDataType[] = weatherDataset.hourly;
...
export const WeatherAreaChart = ({ weatherData }: { weatherData: WeatherDataType }) => {
	const chartDataSet = areaChartDatasetGenerator(weatherData);
